...
class FacebookAPI:
    ...
    def get_page_feed(self, limit: int = 10, fields: str = "id,message,created_time,permalink_url"):
        return self._make_request('GET', f"{config.FACEBOOK_PAGE_ID}/feed", params={'limit': limit, 'fields': fields})
